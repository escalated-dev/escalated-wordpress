...
class Admin_Menu
{
    ...
    public function add_menus(): void
    {
        ...
        add_submenu_page('escalated', __('Newsletters', 'escalated'), __('Newsletters', 'escalated'), 'escalated_newsletters_manage', 'escalated-newsletters', [new Admin_Newsletters, 'render']);
